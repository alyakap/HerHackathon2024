...
const LandingPage = () => {
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <Typography variant="h3" gutterBottom>Welcome to {config.projectName}</Typography>
            <Typography variant="h6" gutterBottom>Find your perfect career path and mentor</Typography>
            <Card>
                <CardContent>
